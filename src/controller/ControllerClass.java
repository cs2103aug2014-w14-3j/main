...
public class ControllerClass implements Controller {
	...
	private Task processUserInput(String content) {
		...
		if (dates.size() > 2) {
			dates = new ArrayList<Date>(dates.subList(dates.size() - 2, dates.size()));
		}
	...
	/**
	 * @author Retrieved from http://stackoverflow.com/questions/3389348/parse-any-date-in-java by Luo Shaohuai
